...
public class GameImpl extends Game {
    ...
    HandOperatedController playerController;
    


    public GameImpl(State state, UI ui, MasterSquirrel player, HandOperatedController playerController) {
        super(state, ui);
        this.player = player;
...
//        }
    ...
    private void a() {
        playerController.setMoveCommand(new XY(-1, 0));
    }
    ...
    private void w() { playerController.setMoveCommand(new XY(0, -1)); }

    private void s() {
        playerController.setMoveCommand(new XY(0, 1));
    }

    private void e() {	//masterenergy
        playerController.setMoveCommand(new XY(0,0));
