...
public final class XY {
    ...
    public String toString() {
        return "XY " + " x= " + y + " y= " + x;		//Nicolas: x und y vertauscht. Erkl�rung: Bsp.: Array[0][5]; Arrayposition in 2d im Kopf vorstellen: die nullte Zeile, und f�nftes Element. toString soll also sagen: x=5 y=0 (wenn wir den Origin des Koordinatensystems links oben haben)
